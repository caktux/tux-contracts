    ...
    ReentrancyGuard
{
    ...
    mapping(bytes32 => bool) private _tokenURIhashes;
        ...
        nonReentrant
    {
        ...
        bytes32 tokenURIhash = sha256(abi.encodePacked(_tokenURI));
        require(
            _tokenURIhashes[tokenURIhash] == false,
        ...
        _tokenURIhashes[tokenURIhash] = true;
